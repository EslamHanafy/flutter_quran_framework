...
#  spec.source       = { :git => "https://github.com/EslamHanafy/ESCore.git", :tag => "#{spec.version}" }
  ...
  spec.vendored_frameworks = 'QuranFramework/Frameworks/App.xcframework', 'QuranFramework/Frameworks/audioplayers.xcframework', 'QuranFramework/Frameworks/flutter_local_notifications.xcframework', 'QuranFramework/Frameworks/flutter_sound_core.xcframework', 'QuranFramework/Frameworks/flutter_sound_lite.xcframework', 'QuranFramework/Frameworks/FlutterPluginRegistrant.xcframework', 'QuranFramework/Frameworks/fluttertoast.xcframework', 'QuranFramework/Frameworks/FMDB.xcframework', 'QuranFramework/Frameworks/path_provider_ios.xcframework', 'QuranFramework/Frameworks/permission_handler.xcframework', 'QuranFramework/Frameworks/share_extend.xcframework', 'QuranFramework/Frameworks/shared_preferences_ios.xcframework', 'QuranFramework/Frameworks/sqflite.xcframework', 'QuranFramework/Frameworks/Toast.xcframework', 'QuranFramework/Frameworks/wakelock.xcframework'
  spec.preserve_path = 'QuranFramework/Frameworks/*'
